...
from app.states.new_request import NewRequestState
...
"""     Main Services Menu      """
@router.callback_query(F.data == CallbackData.NEW_REQUEST.value)
